...
export default function Profile() {
    return (
        <html lang="en">
            ...
            <body dir='rtl' className="md:h-full">
                <ProfileView />
                <Footer />
            </body>
        </html>
    ...
    return (
        <section className='w-11/12 border border-gray-400 my-20 mx-auto py-6 px-4 rounded-2xl flex flex-col justify-center items-center'>
            <div className='relative flex items-center justify-center w-40'>
                ...
                <Link href="#" className='w-14 h-14 rounded-full bg-cyan-200 text-center flex justify-center items-center absolute -bottom-4 left-1'></Link>
            </div>
