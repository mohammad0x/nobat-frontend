        ...
        <html lang="en">
            ...
            <body dir='rtl'>
                ...
                <section className='bg-gray-950 w-screen h-screen flex items-center justify-center'>
                    <div className='w-72 md:w-1/2 bg-white text-center pt-6 rounded'>
                        <h1 className='text-2xl md:text-3xl'>ویرایش پروفایل</h1>
                        <form method='POST' className='w-full text-center'>
                            <input type="text" name='first_name' className='w-64 md:w-80 h-10 md:h-11 mb-2 border-0 border-b' placeholder='نام'/>

                            <input type="text" name='last_name' className='w-64 md:w-80 h-10 md:h-11 mb-2 border-0 border-b' placeholder='نام خانوادگی'/>

                            <input type="text" name='nationalcode' className='w-64 md:w-80 h-10 md:h-11 mb-2 border-0 border-b' placeholder='کدملی'/>

                            <input type="text" name='phone' className='w-64 md:w-80 h-10 md:h-11 mb-2 border-0 border-b' placeholder='شماره همراه'/>

                            <input type="text" name='city' className='w-64 md:w-80 h-10 md:h-11 mb-2 border-0 border-b' placeholder='شهر'/>
