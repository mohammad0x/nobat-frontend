...
export default function editCreateService() {
    return (
        <html lang="en">
        <head>
            <meta charSet="UTF-8"/>
                ...
                <section className='bg-gray-950 w-screen h-screen flex items-center justify-center'>
                    <div className='w-72 md:w-7/12 w-98 bg-white pt-6 rounded text-center'>
                        ...
                        <form method='POST' className='w-full h-full text-center flex flex-col items-center'>
                            ...
                            <input value='سلام' type="text" name='title' className='w-64 md:w-96 h-10 md:h-12 mb-2 border-0 border-b'/>

                            <input value='slug' type="text" name='slug' className='w-64 md:w-96 h-10 md:h-12 mb-2 border-0 border-b'/>

                            <input value='image' type="file" name='first_name' className='w-64 md:w-96 lg:w-96 h-10 md:h-12 mb-6 border-0 border-b border-b-gray-400 text-sm'/>
