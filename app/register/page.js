            ...
            <body dir='rtl' className='footerBody'>
                <section className='w-screen h-screen px-5 bg-gray-950 flex items-center justify-center'>
                    <div className=' w-auto md:w-auto bg-white rounded-lg py-4 md:py-7 px-6 flex flex-col-reverse md:flex-row md:items-center'>
                        <div className='flex items-center flex-col mt-4 md:mt-0 md:ms-6'>
                            ...
                            <form method='POST' className='flex flex-col mt-5 items-center'>
                                ...
                                <p className='text-sm'>ثبت نام به عنوان <Link href="../registerHairstyle" className='text-blue-700 hover:text-blue-900 duration-400'>ارایشگر</Link></p>
                                <p className='text-sm mb-1'>اکانت دارید؟ <Link href="../login" className='text-blue-700 hover:text-blue-900 duration-400'>وارد</Link> شوید</p>
                            </form>
                        </div>
