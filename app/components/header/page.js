...
export default function Header() {
    return (
        <header className='bg-gray-950 h-4/6 md:h-4/6 lg:h-3/5 text-center pt-14'>
            ...
            <a href="/search"><input type="search" className='search-border rounded-lg w-11/12 h-9 p-3 mt-16 bg-gray-950 font-size placeholder:text-right placeholder:text-gray-300' placeholder='سرویس مورد نظر خود را جستجو کنید...'/></a>
