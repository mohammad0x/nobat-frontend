...
export default function Footer() {
    return (
        <section className='sticky bottom-0 rounded-t-xl shadow-stone-600 w-full h-20 bg-gray-950 text-xl text-center flex justify-center items-center text-gray-400'>
