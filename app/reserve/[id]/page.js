            ...
            <body dir='rtl'>
                <section className='flex justify-center items-center bg-gray-950 w-full h-screen'>
                    <div className='w-72 h-80 md:w-10/12 lg:w-1/2 md:h-96 border border-gray-400 rounded-lg flex sm:items-center md:justify-around flex-col md:flex-row py-8 md:py-14 px-4 md:px-7 bg-white'>
                        ...
                        <form action="" className='flex flex-col sm:mt-8 items-center md:w-6/12 lg:w-1/2'>
                            <input type="date" className='w-64 h-10 md:w-11/12 md:h-11 rounded mb-5 shadow focus:shadow-lg'/>
                            <input type="time" className='w-64 h-10 md:w-11/12 md:h-11 rounded mb-5 shadow focus::shadow-lg'/>
