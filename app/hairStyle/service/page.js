...
function Collapse() {
    return (
        <section className='flex h-28 bg-white'>
            <ul className='w-full h-full flex text-lg'>
                <li className='w-1/3 h-full bg-gray-950 text-white border-t'>
                    <Link className='w-full h-full flex justify-center items-center' href=''>سرویس ها</Link>
                </li>
                <li className='w-1/3 border-l border-black h-full border-y'>
                    <Link className='w-full h-full flex justify-center items-center' href='post'>نمونه کارها</Link>
                </li>
                <li className='w-1/3 h-full border-y border-black'>
                    <Link className='w-full h-full flex justify-center items-center' href='review'>نظرات</Link>
                </li>
            </ul>
        </section>
    )
...
function ServiceCard(){
    return (
        <form method="POST" className='w-72 md:w-96 bg-white flex flex-col items-center mt-5 md:mb-4 border border-gray-400 rounded-lg px-4 py-4 md:py-6 shadow hover:shadow-lg duration-500'>
            <img
                className='rounded-lg w-64 md:w-80 mx-auto mb-4'
            ...
            <div className='w-full px-1 flex justify-between items-center'>
                <h1 className='text-2xl'>سلام</h1>
                <p>240000 تومان</p>
            </div>
            <div className='w-full text-right'>
                <h4 className='mt-2'>سریع و درعین حال عالی</h4>
            </div>
            <input type="submit" className='w-64 h-12 border border-green-600 rounded-lg text-green-600 hover:text-white hover:bg-green-600 hover:border-white mt-4 shadow hover:shadow-lg hover:shadow-green-100 duration-500'/>
        </form>
    )
}