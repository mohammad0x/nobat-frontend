    ...
    return (
        <form method="POST" className='w-72 md:w-96 bg-white flex flex-col items-center md:mb-4 border border-gray-400 rounded-lg px-4 py-4 md:py-6 shadow hover:shadow-lg duration-500'>
            ...
            <div className='w-full px-1 flex justify-between items-center'>
                <h1 className='text-2xl'>{profile.title}</h1>
                <p>{profile.price} تومان</p>
            </div>
            <div className='w-full text-right'>
                <h4 className='mt-2'>{profile.desc}</h4>
            </div>
            <input value='رزرو' type="submit" className='w-64 h-12 border border-green-600 rounded-lg text-green-600 hover:text-white hover:bg-green-600 hover:border-white mt-4 shadow hover:shadow-lg hover:shadow-green-100 duration-500'/>
        </form>
    )
}