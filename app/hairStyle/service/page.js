    ...
    return (
        <html lang="en">
            ...
            <body dir='rtl'>
                <HeaderHair />
                <Collapse />
                <div className='flex items-center flex-col bg-gray-950 py-6'>
                    <ServiceCard />
                </div>
                <About />
            </body>
...
function ServiceCard(){
    return (
        <form method="POST" className='w-72 md:w-96 bg-white flex flex-col items-center md:mb-4 border border-gray-400 rounded-lg px-4 py-4 md:py-6 shadow hover:shadow-lg duration-500'>
            <img
