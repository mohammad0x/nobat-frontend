                ...
                <section className='bg-gray-950 w-screen h-screen flex items-center justify-center'>
                    <div className='w-72 md:w-1/2 w-98 bg-white py-6 rounded text-center'>
                        ...
                        <form method='POST' className='w-full h-full text-center flex flex-col items-center'>
                            <input type="password" name='new_password1' className='w-64 md:w-96 h-10 md:h-11 mb-5 border-0 border-b' placeholder='رمزعبور جدید'/>

                            <input type="password" name='new_password2' className='w-64 md:w-96 h-10 md:h-11 mb-10 border-0 border-b' placeholder='تکرار رمزعبور'/>
